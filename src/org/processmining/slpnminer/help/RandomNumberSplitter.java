...
public class RandomNumberSplitter {
    ...
    public static void main(String[] args) {
		...
		try {
			XLog log = (XLog) new OpenLogFileLiteImplPlugin().importFile(context, new File("/Applications/Programming/xes/a10.xes"));
			...
			for (int i=0;i<10;i++) {
				...
				String file = "/Applications/Programming/xes/sub/train" + i+".xes"; 
				FileOutputStream out = new FileOutputStream(file);
				logSerializer.serialize(trainLog, out);
				out.close();
				
				String file2 = "/Applications/Programming/xes/sub/test" + i+".xes"; 
